...
{
    public partial class TRN_MOVABLE : System.Web.UI.UserControl
    {
            ...
            using (SqlConnection con = new SqlConnection(ConnectionString))
            {
                try
                {
                    ...
                    foreach (DataRow dr in dt.Rows)
                    {
                        ...
                        dr["Combined"] = dr["EMPNAME"].ToString() + "-" + dr["ref_no"].ToString() + "-" + dr["description"].ToString() + "- Rs. " + dr["trn_amount"].ToString();
        ...
        protected void rb_addnew_Click(object sender, EventArgs e)
        {
            ...
            //TRN_MOVABLE myremotepost = new TRN_MOVABLE();
        ...
        protected void rb_save_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //else if (rtb_amt.Text.Trim().ToString() == "")
                //{
                //    error_tag = "E";
                //    FnDisplayMessage("Enter Purchase Value/Premium Paid");
                //}
                ...
                {
                    error_tag = "E";
                    FnDisplayMessage("Acquisition Date can not me greater then : " + Convert.ToDateTime(Session["period_to"]).ToString("dd/MM/yyyy"));
                }
