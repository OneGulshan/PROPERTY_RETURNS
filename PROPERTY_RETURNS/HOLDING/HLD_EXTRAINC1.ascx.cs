...
{
    public partial class HLD_EXTRAINC1 : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
               ...
               bind_grid(); //comment by Ghanshyam
            }
            //bind_grid();
        ...
        protected void bind_grid()
        {
            ...
            //                cmd_gettrn.CommandType = CommandType.StoredProcedure;
            //                cmd_gettrn.Parameters.Add("@PERNR", SqlDbType.VarChar).Value = Session["emp"].ToString();
            //                cmd_gettrn.Parameters.Add("@T_TYPE", SqlDbType.VarChar).Value = "EX_TR_SA";
            //                //  cmd_gettrn.Parameters.Add("@holdingdt", SqlDbType.VarChar).Value = Convert.ToDateTime(holdingdtpre).ToString("MM-dd-yyyy"); ;
            //                //cmd_gettrn.Parameters.Add("@holdingdt", SqlDbType.VarChar).Value = holdingdtpre;
            //                cmd_gettrn.Parameters.Add("@holdingdt", SqlDbType.VarChar).Value = Convert.ToDateTime(holdingdtpre).ToString("MM-dd-yyyy", System.Globalization.CultureInfo.InvariantCulture);
            //                ad.SelectCommand = cmd_gettrn;
        ...
        //protected void RG_TRN_SelectedIndexChanged(object sender, System.EventArgs e)
        //{
        //    string refnum = (RG_TRN.SelectedItems[0] as GridDataItem).GetDataKeyValue("REFNUM").ToString();
        ...
        protected void RG_TRN_OnSelectedIndexChanged(object sender, EventArgs e)
        {
          ...
          // string REFNUM = dataItem.OwnerTableView.DataKeyValues[dataItem.ItemIndex]["REFNUM"].ToString();
           ...
           // string customerID = dataItem.OwnerTableView.DataKeyValues[dataItem.ItemIndex]["CustomerID"].ToString();
            ...
            if (dataItem != null)
            {
                ...
                //string empname = dataItem["EMPNAME"].Text;
                rcb_EMP.SelectedValue = dataItem["EMPNO"].Text;
               // rcb_EMP.Text = dataItem["PERNR"].Text;
               // ddl_Acq_Source.SelectedValue = dataItem["PERNR"].Text;
                rdp_acqdt.SelectedDate = Convert.ToDateTime(dataItem["ACQDT"].Text);
                parent_holddt = Session["getDate"].ToString();
                rdp_hlddt.SelectedDate = Convert.ToDateTime(parent_holddt);
                rdp_trndt.SelectedDate = rdp_hlddt.SelectedDate;
                ...
                ddl_Acq_Source.SelectedValue = dataItem["ASCAT"].Text;

                //rdp_trndt.SelectedDate = rdp_hlddt.SelectedDate;
                txt_details.Text = dataItem["Acq_Remarks"].Text.Replace("&nbsp;", "");
                txt_Amt.Text = dataItem["TRNAMT"].Text.Replace("&nbsp;", "");
                ...
                //}
                //--------------------- ++ Code Starts ++ ------------------------------------------------------------------------
                txt_Amt.Text = dataItem["TRNAMT"].Text.Replace("&nbsp;", "");  // Populated from database

                //Converting value to words
                decimal d1 = decimal.Parse(txt_Amt.Text);
                try
                {
                    int val1 = Decimal.ToInt32(d1);
                    lbl_amt_value.Text = Words_To_Rupees(val1);
                }

                catch (FormatException)
                {
                    lbl_amt_value.Text = "Enter digits only";
                }

                txt_Amt.Text = Convert_To_Indian_Currency_System(txt_Amt.Text);
                //--------------------- -- Code Ends -- -------------------------------------------------------------------------
        ...
        protected void rb_save_Click(object sender, EventArgs e)
        {
           ...
           // RadWindow2.OpenerElementID = RadButton1.ClientID;

            //RadWindow2.Visible = true; 
            //RadWindow2.OpenerElementID = rb_save.ClientID;
            ...
            try
            {
                ...
                {
                    error_tag = "E";
                    FnDisplayMessage("Select Name Of Income Owner");
                }
                else if (ddl_Acq_Source.SelectedValue.ToString() == "")
                {
                    error_tag = "E";
                    FnDisplayMessage("Select Source of Other Income");
                }
                ...
                else if (ddl_Acq_Source.SelectedValue.ToString() == "10" && txt_details.Text.ToString() == "")
                {
                    error_tag = "E";
                    FnDisplayMessage("Enter Source of Other Income (Others) details");
                }
                ...
                else if (txt_Amt.Text.Trim().ToString() == "") // Mandatory Field
                {
                    error_tag = "E";
                    FnDisplayMessage("Enter Amount in Rs.");
                }
                ...
                //}
                //else if (obj_gl.FnValidateFloat(txt_Amt.Text.Trim().ToString()) == 0 && txt_Amt.Text.Trim().ToString() != "")
                //{
                //    error_tag = "E";
...
//@ACQDT smalldatetime,
//@TRNNATURE varchar(5),
//@INTRATE decimal(18, 4),
//@STATUS varchar(2),
//@REMARKS varchar(250),
//@IPADDR varchar(15),
//@FV_RELATION varchar(50),
//@FV_COUNTRIES varchar(50),
//@FV_START_DATE date,
//@FV_END_DATE date,
//@FV_DURATION int,
//@FV_FUND_SOURCE varchar(50),
//@FV_FUND_SOURCE_OTHER varchar(50),
//@BALAMT decimal(18, 4),
//@TRN_TO_HOLDING char(1),
//@ACQFROM varchar(max),
//@ASCAT_OTHDESC varchar(max),
//@ASTYPE_OTHDESC varchar(max),
//@ACQ_SOURCE_OTHDESC varchar(max)
                                ...
                                cmd_inttrn.Parameters.Add("@PRPTYPE", SqlDbType.VarChar).Value = "EX";
                                cmd_inttrn.Parameters.Add("@ASCAT", SqlDbType.VarChar).Value = ddl_Acq_Source.SelectedValue.ToString();
                                cmd_inttrn.Parameters.Add("@ASTYPE", SqlDbType.VarChar).Value = ddl_Acq_Source.SelectedValue.ToString();
                                ...
                                string update_txt_Amt = txt_Amt.Text;
                                update_txt_Amt = charsToDestroy.Replace(update_txt_Amt, "");
                                ...
                                {
                                    cmd_inttrn.Parameters.Add("@TRNAMT", SqlDbType.VarChar).Value = Convert.ToDecimal(update_txt_Amt);
                                }
                                ...
                                if (txt_Amt.Text.Trim().ToString() == "")
                                {
                                    cmd_inttrn.Parameters.Add("@ANINCM", SqlDbType.VarChar).Value = DBNull.Value;
                                }
                                else
                                {
                                    cmd_inttrn.Parameters.Add("@ANINCM", SqlDbType.VarChar).Value = Convert.ToDecimal(update_txt_Amt);
                                }
                                ...
                                {
                                    cmd_inttrn.Parameters.Add("@CONSVAL", SqlDbType.VarChar).Value = Convert.ToDecimal(update_txt_Amt);
                                }
                                //---------------------------Code ends----------------------------------------
                                ...
                                cmd_inttrn.Parameters.Add("@OBJECTID", SqlDbType.VarChar).Value = DBNull.Value;
                                cmd_inttrn.Parameters.Add("@IDDESC", SqlDbType.VarChar).Value = DBNull.Value;
                                ...
                                cmd_inttrn.Parameters.Add("@ACQSRC", SqlDbType.VarChar).Value = "EX";
                                cmd_inttrn.Parameters.Add("@ACQDESC", SqlDbType.VarChar).Value = ddl_Acq_Source.SelectedItem.Text;
                        ...
                        if (error_tag == "")
                        {
                            ...
                            using (SqlConnection con = new SqlConnection(ConnectionString))
                            {
                                try
                                {
                                    ...
                                    cmd_inttrn = new SqlCommand("SP_INSERT_TRANSACTION_EMPLOYEE_EX", con);
                                   ...
                                   // string update_txt_cumu = txt_cumu.Text;
                                    ...
                                    cmd_inttrn.Parameters.Add("@ACQSRC", SqlDbType.VarChar).Value = "EX";
                                    cmd_inttrn.Parameters.Add("@ACQDESC", SqlDbType.VarChar).Value = ddl_Acq_Source.SelectedItem.Text;//txt_details.Text;
                                    if (rdp_acqdt.SelectedDate.ToString().Trim() == "")
                                    {
                                        cmd_inttrn.Parameters.Add("@ACQDT", SqlDbType.DateTime).Value = DBNull.Value;
                                    }
                                    ...
                                    cmd_inttrn.Parameters.Add("@TRN_TO_HOLDING", SqlDbType.VarChar).Value = "Y";
                                    cmd_inttrn.Parameters.Add("@ACQFROM", SqlDbType.VarChar).Value = "";
                                    cmd_inttrn.Parameters.Add("ACQ_SOURCE_OTHDESC", SqlDbType.VarChar).Value = txt_details.Text;
                            ...
                            if (error_tag == "")
                            {
                                ...
                                using (SqlConnection con = new SqlConnection(ConnectionString))
                                {
                                    try
                                    {
                                        ...
                                        cmd_inttrn.Parameters.Add("@REFNO", SqlDbType.VarChar).Value = lbl_refno.Text;
                                        cmd_inttrn.Parameters.Add("@PERNR", SqlDbType.VarChar).Value = rcb_EMP.SelectedValue;
                                        cmd_inttrn.Parameters.Add("@TRNDT", SqlDbType.DateTime).Value = Convert.ToDateTime(rdp_acqdt.SelectedDate.ToString());
                                        cmd_inttrn.Parameters.Add("@PRPTYPE", SqlDbType.VarChar).Value = "EX";
                                        ...
                                        cmd_inttrn.Parameters.Add("@ACQSRC", SqlDbType.VarChar).Value = ddl_Acq_Source.SelectedValue.ToString();
                                        cmd_inttrn.Parameters.Add("@ACQDESC", SqlDbType.VarChar).Value = ddl_Acq_Source.SelectedItem.Text;
                                        if (rdp_acqdt.SelectedDate.ToString().Trim() == "")
                                        {
                                            cmd_inttrn.Parameters.Add("@ACQDT", SqlDbType.DateTime).Value = DBNull.Value;
                                        ...
                                        {
                                            cmd_inttrn.Parameters.Add("@ACQDT", SqlDbType.DateTime).Value = rdp_acqdt.SelectedDate.ToString();
                                        }
                                        cmd_inttrn.Parameters.Add("@STATUS", SqlDbType.VarChar).Value = "HV";
                                        cmd_inttrn.Parameters.Add("@REMARKS", SqlDbType.VarChar).Value = rtb_remarks.Text;
                                        cmd_inttrn.Parameters.Add("@IPADDR", SqlDbType.VarChar).Value = Request.ServerVariables["REMOTE_ADDR"];
        ...
        protected void ddl_Acq_Source_OnSelectedIndexChanged(object sender, System.EventArgs e)
        {
            if (ddl_Acq_Source.SelectedValue == "3" || ddl_Acq_Source.SelectedValue == "10")
            {
                lbl_details.Visible = true;
                txt_details.Visible = true;
                lbl_details.Text = "Details of Other Income"; 
            }
            else
            {
        ...
        protected void txt_Amt_TextChanged(object sender, System.EventArgs e)
        {
            string moneyString = "";
            try
            {
                //Converting value to words
                string value = txt_Amt.Text;
                //alert(value);
            ...
            txt_Amt.Text = Convert_To_Indian_Currency_System(moneyString);
