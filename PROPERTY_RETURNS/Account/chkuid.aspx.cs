...
namespace PROPERTY_RETURNS.Account
{
    public partial class chkuid : System.Web.UI.Page
    {
        ...
        {
            Response.Write("<script>alert('chkuid');</script>");
        ...
        protected void redirectuser(string uid)
        {
            ...
            //{
                //while (reader.Read())
                //{
            string checkuser = "select FIRSTNAME,LASTNAME,GRADE,DEPT,PAYAREA from [10.0.0.216].[ERPHRDB].[dbo].[EMPMASTER] where PERNR='" + pernr + "'";
