<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PRINTALL_HOLDINDS_TRNS_BOTH.aspx.cs" Inherits="PROPERTY_RETURNS.REPORTS_ASPX.PRINTALL_HOLDINDS_TRNS_BOTH" %>
 ...
 <script language="javascript" type="text/javascript">
     ...
     <script type = "text/javascript">
         ...
         function showModalPopUp() {
             ...
             popUpObj = window.open("PRINTONLY_HOLDINGD_TRNS_BOTH.aspx?holdingdt=" + label.innerHTML,
            "ModalPopUp",
            "toolbar=no," +
            "scrollbars=yes," +
            "location=no," +
...
For the purpose of this Sec., “dependent children” means sons and daughters who have no separate means of earning and are wholly dependent on the public servant for their livelihood.
    ...
    <%--<asp:Button ID="Button1" runat="server" Text="Print" OnClientClick="javascript:printDiv('printablediv')" />--%>
     ...
     <input id="Button2" type="button" value="Print All Submitted Holdings/Saved Transactions" class="btn btn-warning width300" onclick="showModalPopUp()" />
