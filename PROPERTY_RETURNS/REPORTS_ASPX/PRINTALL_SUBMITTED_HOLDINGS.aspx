<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="PRINTALL_SUBMITTED_HOLDINGS.aspx.cs" Inherits="PROPERTY_RETURNS.REPORTS_ASPX.PRINTALL_SUBMITTED_HOLDINGS" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <script language="javascript" type="text/javascript">
     ...
     <script type = "text/javascript">
         ...
         function showModalPopUp() {
             ...
             popUpObj = window.open("PRINTONLY_SUBMITTED_HOLDINGS.aspx?holdingdt=" + label.innerHTML,
            "ModalPopUp",
            "toolbar=no," +
            "scrollbars=yes," +
            "location=no," +
    ...
    <div style="background-color: #F7F7F7;" id="tabs">
        <asp:Label ID="Label1" runat="server" Text="Print Submitted Holdings" ForeColor="Red"></asp:Label>
...
For the purpose of this Sec., “dependent children” means sons and daughters who have no separate means of earning and are wholly dependent on the public servant for their livelihood.
    ...
    <%--<asp:Button ID="Button1" runat="server" Text="Print" OnClientClick="javascript:printDiv('printablediv')" />--%>
     ...
     <input id="Button2" type="button" value="Print All Submitted Forms" class="btn btn-warning width300" onclick="showModalPopUp()" />
