...
{
    public partial class PRINTALL_HOLDINDS_TRNS_BOTH : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Label1.Text = "View and Print Submitted Holdings & Saved Transactions for Holding Date : " + Convert.ToDateTime(Session["getDate"]).ToString("dd/MM/yyyy");
            ...
            using (SqlConnection con = new SqlConnection(ConnectionString))
            {
                try
                {
                    ...
                    //    lb_info.Text = "No Holdings has been submitted yet. You can not print submitted holding.";
