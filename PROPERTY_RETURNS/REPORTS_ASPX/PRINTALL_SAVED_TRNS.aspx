<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PRINTALL_SAVED_TRNS.aspx.cs" Inherits="PROPERTY_RETURNS.REPORTS_ASPX.PRINTALL_SAVED_TRNS" %>
    ...
    <script language="javascript" type="text/javascript">
     ...
     <script type = "text/javascript">
         ...
         function showModalPopUp() {
             ...
             popUpObj = window.open("PRINTONLY_SAVED_TRNS.aspx?holdingdt=" + label.innerHTML,
            "ModalPopUp",
            "toolbar=no," +
            "scrollbars=yes," +
            "location=no," +
