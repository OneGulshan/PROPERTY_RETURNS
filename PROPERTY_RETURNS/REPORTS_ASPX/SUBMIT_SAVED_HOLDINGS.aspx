<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="SUBMIT_SAVED_HOLDINGS.aspx.cs" Inherits="PROPERTY_RETURNS.REPORTS_ASPX.SUBMIT_SAVED_HOLDINGS" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <script language="javascript" type="text/javascript">
        ...
        function CheckForms() {
            var form1 = $('#pnl_form1_value').html();
            var form3 = $('#pnl_form3_value').html();
            var form4 = $('#pnl_form4_value').html();
            var form2 = $('#Panel1_value').html();
            var form5 = $('#pnl_form_5_value').html();
            if (form1 == 0) {
                $('#lblErrorMessage').html("Please Ensure that you have Verified Form-1 before Submitting all Holdings.");
                return false;                
            } else if (form2 == 0) {
                $('#lblErrorMessage').html("<br/> Please Ensure that you have Verified Form-2 before Submitting all Holdings.");
                return false;
            } else if (form3 == 0) {
                $('#lblErrorMessage').html("<br/> Please Ensure that you have Verified Form-3 before Submitting all Holdings.");
                return false;
            } else if (form4 == 0) {
                $('#lblErrorMessage').html("<br/> Please Ensure that you have Verified Form-4 before Submitting all Holdings.");
                return false;
            } else if (form5 == 0) {
                $('#lblErrorMessage').html("<br/> Please Ensure that you have Verified Form-5 before Submitting all Holdings.");
                return false;
            } else if (form1 == form2 == form3 == form4 == 1) {
//                $('#lblErrorMessage').html("sdfakl");
                //                return true;
                var Ok = confirm('Are you sure to Submit Holdings? Once Submitted you can not change or add Holdings for this Period');
                if (Ok)
                    return true;
                else
                    return false;
            ...
            return false;
            //alert($('#pnl_form1_value').html());
            //$('#lblErrorMessage').html("aewt4");
        }
...
<script>
    ...
    <div style="background-color: #F7F7F7;" id="tabs">
     <div style="background-color: #F7F7F7;" id="Div1">
        <asp:Label ID="Label1" runat="server" Text="Submit Saved Holdings" ForeColor="Red"></asp:Label>
       ...
       <%-- <button id="btnContinue5" class="btn btn-primary tabItem" data-tab="pnl_form0" style="width: 180px">
        ...
        <span id="pnl_form0_value" class="hidden">1</span> <span id="pnl_form4_value" class="hidden">
            0</span> <span id="Panel1_value" class="hidden">0</span> <span id="pnl_form1_value"
                class="hidden">0</span> <span id="pnl_form3_value" class="hidden">0</span><span id="pnl_form5_value"
                class="hidden">0</span>
    </div>
...
For the purpose of this Sec., “dependent children” means sons and daughters who have no separate means of earning and are wholly dependent on the public servant for their livelihood.
        ...
        <div align="center">
            ...
            Statement of Debts and Other Liabilities on first appointment or as on
             <asp:Label ID="hlddt3" runat="server" Text="" Font-Underline="True"></asp:Label></span>
        </div>
        <asp:GridView ID="gv_form4" runat="server" AutoGenerateColumns="False" Width="100%"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="nature_amt" HeaderText="Nature of debt / Balance Liablity Amount"
        ...
        <div align="center">
            ...
            Statement of Forign Visits as on 
            <asp:Label ID="hlddt4" runat="server" Text="" Font-Underline="True"></asp:Label>
        </div>
        <asp:GridView ID="gv_form5" runat="server" AutoGenerateColumns="False" Width="100%"
                        ...
                        <Columns>
                           ...
                           <asp:BoundField DataField="EMPNAME" HeaderText="NAME (Self/spouse or dependent children)"   ReadOnly="True" SortExpression="EMPNAME" Visible="True" />
                            ...
                            <asp:BoundField DataField="FV_COUNTRIES_NAME"  HeaderText="Country Visited" ReadOnly="True" SortExpression="FV_COUNTRIES_NAME" />
                            <asp:BoundField DataField="FV_DURATION"   HeaderText="Duration of Stay" ReadOnly="True" />   
                            <asp:BoundField DataField="FV_START_DATE"   HeaderText="Start Date" ReadOnly="True" />   
                            <asp:BoundField DataField="FV_END_DATE"   HeaderText="End Date" ReadOnly="True" />   
                            <asp:BoundField DataField="FV_VISIT_PURPOSE"  HeaderText="Purpose of Visit" ReadOnly="True" SortExpression="FV_VISIT_PURPOSE" />
                            <asp:BoundField DataField="Acq_Source"  HeaderText="Source of Funding" ReadOnly="True" SortExpression="Acq_Source" />
                            <asp:BoundField DataField="FV_EXP_INCUR"  HeaderText="Expenditure Incurred" ReadOnly="True" SortExpression="FV_EXP_INCUR" />
        ...
        <asp:Panel ID="pnl_form6" runat="server">
        <div align="center">
            <span class="style3">FORM NO. VI<br />
            Details of Other Income </span>
            <asp:Label ID="Label5" runat="server" Text="" Font-Underline="True"></asp:Label>
        </div>
        <asp:GridView ID="gv_form6" runat="server" AutoGenerateColumns="False" Width="100%"
            CellPadding="15" BorderColor="Black" BorderStyle="Solid" BorderWidth="1px" CssClass="style3"
            HeaderStyle-VerticalAlign="Top" EmptyDataText="Nil">
            <Columns>
                <asp:TemplateField HeaderText="S No">
               ...
               <asp:BoundField DataField="Acq_Remarks"  HeaderText="Source of Funding" ReadOnly="True" SortExpression="Acq_Remarks" />
                <asp:BoundField DataField="ANINCM" HeaderText="Total annual income "
                    ReadOnly="True" SortExpression="ANINCM" Visible="True" />
               <asp:BoundField DataField="REMARKS"    HeaderText="REMARKS" ReadOnly="True" />
            </Columns>
        </asp:GridView>
        ...
        <br />
        <br />
        <%--<span id="btnSave" class="btn btn-danger width300 btnSave" onclick="CheckForms();">Submit All Saved Holdings</span>--%>
        
        <asp:Button ID="rbt_submit" runat="server" Text="Submit All Saved Holdings" 
                OnClientClick="return CheckForms();" CssClass="btn btn-danger width300" 
                onclick="rbt_submit_Click">
        </asp:Button>
        <asp:Button ID="Button1" runat="server" Text="Print All Saved Forms" OnClientClick="return showModalPopUp();" CssClass="btn btn-warning width300">
        </asp:Button>
       <%-- <span id="Button2" class="btn btn-warning width300" onclick="showModalPopUp()" >Print All Forms</span>--%>
