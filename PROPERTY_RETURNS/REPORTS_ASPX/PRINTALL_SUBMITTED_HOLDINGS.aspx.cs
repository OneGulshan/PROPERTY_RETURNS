...
{
    public partial class PRINTALL_SUBMITTED_HOLDINGS : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Label1.Text = "View and Print Submitted Holdings for Holding Date : " + Convert.ToDateTime(Session["getDate"]).ToString("dd/MM/yyyy");
