...
{
    public partial class PRINTALL_SAVED_TRNS : System.Web.UI.Page
    {
       string ConnectionString = System.Configuration.ConfigurationManager.ConnectionStrings["PRConnectionString"].ConnectionString;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Label1.Text = "View and Print Submitted Holdings for Holding Date : " + Convert.ToDateTime(gv_holdingdt).ToString("dd/MM/yyyy");
        ...
        {
            Response.Redirect("PRINTONLY_SAVED_TRNS.aspx");   
        }
