...
{
    public partial class PRINT_SAVED_HOLDINGS : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            cmd_gettrn.Parameters.Add("@HOLDDT", SqlDbType.VarChar).Value = DateTime.Now;
            ...
            foreach (DataRow row in dt_dep.Rows)
            {
                ...
                string[] selectedColumns = new[] { "Description", "TRNAMT", "Acq_Source", "REMARKS" };
                string[] selectedColumns_motor = new[] { "Description","IDDESC","OBJECTID","TRNAMT", "Acq_Source", "REMARKS" };
                string[] selectedColumns_jewel = new[] { "Description", "QTY", "UNIT", "TRNAMT", "Acq_Source", "REMARKS" };
                dt.Clear();
