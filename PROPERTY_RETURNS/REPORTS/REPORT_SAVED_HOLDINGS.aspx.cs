...
{
    public partial class REPORT_SAVED_HOLDINGS : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
           // Label3.Text = DateTime.Now.ToString("dd/MM/yyyy", System.Globalization.CultureInfo.InvariantCulture);
            //lbl_empnop.Text = Session["id"].ToString();
            lbl_empnop.Text = Request.QueryString["pernr"].ToString();
            ...
            using (SqlConnection con = new SqlConnection(ConnectionString))
            {
                try
                {
                    ...
                    cmd_gethdt.Parameters.Add("@PERNR", SqlDbType.VarChar).Value = Request.QueryString["pernr"].ToString();
                    cmd_gethdt.Parameters.Add("@T_TYPE", SqlDbType.VarChar).Value = "DT_HO";
                    cmd_gethdt.Parameters.Add("@holdingdt", SqlDbType.VarChar).Value = Convert.ToDateTime(Session["getDate"]).ToString("MM-dd-yyyy");
                    ...
                    cmd_gettrn.Parameters.Add("@PERNR", SqlDbType.VarChar).Value = Request.QueryString["pernr"].ToString();
                    cmd_gettrn.Parameters.Add("@HOLDDT", SqlDbType.DateTime).Value = holddt;
            ...
            foreach (DataRow row in dt_dep.Rows)
            {
                using (SqlConnection con = new SqlConnection(ConnectionString))
                {
                    try
                    {
                        ...
                        //Panel1.Controls.Add(new LiteralControl("<div style='page-break-before: always;'></div>"));
                        ...
                        //Panel1.Controls.Add(new LiteralControl("<style>p.page { page-break-after: always; }</style>"));
                        //Panel1.Controls.Add(new LiteralControl("<p class=page></p>"));
        ...
        {
            Server.Transfer("~/FORMS/GEN_REPORT1.aspx");
        }
