...
{
    public partial class REPORT_SUBMITTED_HOLDINGS : System.Web.UI.Page
    {
           ...
           // Label3.Text = DateTime.Now.ToString("dd/MM/yyyy", System.Globalization.CultureInfo.InvariantCulture);
            ...
            using (SqlConnection con = new SqlConnection(ConnectionString))
            {
                try
                {
                    ...
                    hlddt4.Text = holddt.ToString("dd/MM/yyyy", System.Globalization.CultureInfo.InvariantCulture);
                    ...
                    cmd_gettrn.Parameters.Add("@STATUS", SqlDbType.VarChar).Value = "SG";
