<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="REPORT_SUBMITTED_HOLDINGS.aspx.cs" Inherits="PROPERTY_RETURNS.REPORTS.REPORT_SUBMITTED_HOLDINGS" %>
...
<body onload="javascript:printDiv('printablediv')">
    ...
    <asp:Button ID="Button2" runat="server" Text="Back" onclick="Button2_Click" Visible="false" />
    ...
    <asp:Panel ID="pnl_form0" runat="server" ClientIDMode="static">
     ...
     <asp:Panel ID="pnl_form1" runat="server">
      ...
      <%--  <div style="page-break-after: always;">--%>
        ...
        <asp:Panel ID="pnl_form5" runat="server">
        <div align="center">
       ...
       <div style=" margin-top: 0; float:right">
        <u>Emp No. : 
            <asp:Label ID="lbl_empnop" runat="server" Text=""></asp:Label></u>
        </div>
    </div>
    </div>
