...
{
    public partial class RP_SAVED_TRANSACTION : System.Web.UI.Page
    {
        ...
        void LoadReport()
        {
            ...
            cryrpt.SetParameterValue("@T_TYPE", "IM_TR_SA");
            cryrpt.SetParameterValue("@T_TYPE2", "LI_TR_SA");
            cryrpt.SetParameterValue("@T_TYPE3", "MO_TR_SA");
