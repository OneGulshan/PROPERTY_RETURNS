...
{
    public partial class RP_SUBMITTED_HOLDING : System.Web.UI.Page
    {
        ...
        void LoadReport()
        {
            ...
            cryrpt.SetParameterValue("@T_TYPE", "IM_HO_SG");
            cryrpt.SetParameterValue("@T_TYPE2", "LI_HO_SG");
            cryrpt.SetParameterValue("@T_TYPE3", "MO_HO_SG");
            cryrpt.SetParameterValue("@V_TYPE", "--");
            cryrpt.SetParameterValue("@V_TYPE1", "++");
