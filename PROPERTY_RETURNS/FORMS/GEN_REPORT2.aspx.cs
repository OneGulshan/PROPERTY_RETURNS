...
{
    public partial class GEN_REPORT2 : System.Web.UI.Page
    {
            ...
            if (!Page.IsPostBack)
            {
                ...
                using (SqlConnection con = new SqlConnection(ConnectionString))
                {
                    try
                    {
                        ...
                        if (Session["role"].ToString() == "S")
                            cmd_getpa = new SqlCommand("SELECT top 1 '%' as PA,'  All' as PROJECT FROM [ERPHR.NTPCLAKSHYA.CO.IN].[ERPHRDB].[dbo].[EMPMASTERINACTIVE] where pa in (" + Session["auth_pa"] + ") union all  SELECT distinct [PA], [PROJECT] FROM [ERPHR.NTPCLAKSHYA.CO.IN].[ERPHRDB].[dbo].[EMPMASTERINACTIVE] where pa in (" + Session["auth_pa"] + ") and PA <>'' and PROJECT <> '' order by PROJECT ", con);
                        else
                            cmd_getpa = new SqlCommand("SELECT top 1 '%' as PA,'  All' as PROJECT FROM [ERPHR.NTPCLAKSHYA.CO.IN].[ERPHRDB].[dbo].[EMPMASTERINACTIVE]  union all  SELECT distinct [PA], [PROJECT] FROM [ERPHR.NTPCLAKSHYA.CO.IN].[ERPHRDB].[dbo].[EMPMASTERINACTIVE] where  PA <>'' and PROJECT <> '' order by PROJECT  ", con);
        ...
        protected void bind_grid()
        {
            ...
            using (SqlConnection con = new SqlConnection(ConnectionString))
            {
                try
                {
                    ...
                    if (Session["role"].ToString() == "S")
                        cmd_getrep = new SqlCommand("SP_GENERAL_REPORT2_SEP", con);
                    else
                        cmd_getrep = new SqlCommand("SP_GENERAL_REPORT1_SEP", con);
        ...
        //    //                if (Session["role"].ToString() == "S")
        //    //                    cmd_getemp = new SqlCommand("SELECT top 1 '%' as PERNR,'   All' as EMPNAME FROM [ERPHR.NTPCLAKSHYA.CO.IN].[ERPHRDB].[dbo].[EMPMASTERINACTIVE] where pa in (" + Session["auth_pa"] + ") union all SELECT [PERNR], RIGHT([PERNR],6)+' / '+[FIRSTNAME]+' '+[LASTNAME] as EMPNAME FROM [ERPHR.NTPCLAKSHYA.CO.IN].[ERPHRDB].[dbo].[EMPMASTERINACTIVE] where pa in (" + Session["auth_pa"] + ") order by empname", con);
        //    //                else
        //    //                    cmd_getemp = new SqlCommand("SELECT top 1 '%' as PERNR,'   All' as EMPNAME FROM [ERPHR.NTPCLAKSHYA.CO.IN].[ERPHRDB].[dbo].[EMPMASTERINACTIVE] union all SELECT [PERNR], RIGHT([PERNR],6)+' / '+[FIRSTNAME]+' '+[LASTNAME] as EMPNAME FROM [ERPHR.NTPCLAKSHYA.CO.IN].[ERPHRDB].[dbo].[EMPMASTERINACTIVE]  order by empname", con);
        //    //            }
        //    //            if (rcb_pa.SelectedItem.Text != "  All" && rcb_psa.SelectedItem.Text == "  All")
        //    //            {
        //    //                if (Session["role"].ToString() == "S")
        //    //                    cmd_getemp = new SqlCommand("SELECT top 1 '%' as PERNR,'   All' as EMPNAME FROM [ERPHR.NTPCLAKSHYA.CO.IN].[ERPHRDB].[dbo].[EMPMASTERINACTIVE] where pa in (" + Session["auth_pa"] + ") union all SELECT [PERNR], RIGHT([PERNR],6)+' / '+[FIRSTNAME]+' '+[LASTNAME] as EMPNAME FROM [ERPHR.NTPCLAKSHYA.CO.IN].[ERPHRDB].[dbo].[EMPMASTERINACTIVE] where PA='" + rcb_pa.SelectedValue + "' order by empname", con);
        //    //                else
        //    //                    cmd_getemp = new SqlCommand("SELECT top 1 '%' as PERNR,'   All' as EMPNAME FROM [ERPHR.NTPCLAKSHYA.CO.IN].[ERPHRDB].[dbo].[EMPMASTERINACTIVE] union all SELECT [PERNR], RIGHT([PERNR],6)+' / '+[FIRSTNAME]+' '+[LASTNAME] as EMPNAME FROM [ERPHR.NTPCLAKSHYA.CO.IN].[ERPHRDB].[dbo].[EMPMASTERINACTIVE] where PA='" + rcb_pa.SelectedValue + "' order by empname", con);
        //    //            }
        //    //            if (rcb_pa.SelectedItem.Text == "  All" && rcb_psa.SelectedItem.Text != "  All")
        //    //            {
        //    //                if (Session["role"].ToString() == "S")
        //    //                    cmd_getemp = new SqlCommand("SELECT top 1 '%' as PERNR,'   All' as EMPNAME FROM [ERPHR.NTPCLAKSHYA.CO.IN].[ERPHRDB].[dbo].[EMPMASTERINACTIVE] where pa in (" + Session["auth_pa"] + ") union all SELECT [PERNR], RIGHT([PERNR],6)+' / '+[FIRSTNAME]+' '+[LASTNAME] as EMPNAME FROM [ERPHR.NTPCLAKSHYA.CO.IN].[ERPHRDB].[dbo].[EMPMASTERINACTIVE] where PSA='" + rcb_psa.SelectedValue + "' order by empname", con);
        //    //                else
        //    //                    cmd_getemp = new SqlCommand("SELECT top 1 '%' as PERNR,'   All' as EMPNAME FROM [ERPHR.NTPCLAKSHYA.CO.IN].[ERPHRDB].[dbo].[EMPMASTERINACTIVE]  union all SELECT [PERNR], RIGHT([PERNR],6)+' / '+[FIRSTNAME]+' '+[LASTNAME] as EMPNAME FROM [ERPHR.NTPCLAKSHYA.CO.IN].[ERPHRDB].[dbo].[EMPMASTERINACTIVE] where PSA='" + rcb_psa.SelectedValue + "' order by empname", con);
        //    //            }
        //    //            if (rcb_pa.SelectedItem.Text != "  All" && rcb_psa.SelectedItem.Text != "  All")
        //    //            {
        //    //                if (Session["role"].ToString() == "S")
        //    //                    cmd_getemp = new SqlCommand("SELECT top 1 '%' as PERNR,'   All' as EMPNAME FROM [ERPHR.NTPCLAKSHYA.CO.IN].[ERPHRDB].[dbo].[EMPMASTERINACTIVE] where pa in (" + Session["auth_pa"] + ") union all SELECT [PERNR], RIGHT([PERNR],6)+' / '+[FIRSTNAME]+' '+[LASTNAME] as EMPNAME FROM [ERPHR.NTPCLAKSHYA.CO.IN].[ERPHRDB].[dbo].[EMPMASTERINACTIVE] where PA='" + rcb_pa.SelectedValue + "' and PSA='" + rcb_psa.SelectedValue + "' order by empname", con);
        //    //                else
        //    //                    cmd_getemp = new SqlCommand("SELECT top 1 '%' as PERNR,'   All' as EMPNAME FROM [ERPHR.NTPCLAKSHYA.CO.IN].[ERPHRDB].[dbo].[EMPMASTERINACTIVE]  union all SELECT [PERNR], RIGHT([PERNR],6)+' / '+[FIRSTNAME]+' '+[LASTNAME] as EMPNAME FROM [ERPHR.NTPCLAKSHYA.CO.IN].[ERPHRDB].[dbo].[EMPMASTERINACTIVE] where PA='" + rcb_pa.SelectedValue + "' and PSA='" + rcb_psa.SelectedValue + "' order by empname", con);
        //    //            }
        ...
        protected void rcb_pa_SelectedIndexChanged(object sender, RadComboBoxSelectedIndexChangedEventArgs e)
        {
            ...
            //    {
            //        //if (Session["role"].ToString()=="S")
            //        //SqlDataSource_PSA.SelectCommand = "SELECT top 1 '%' as PSA,'  All' as Location FROM [ERPHR.NTPCLAKSHYA.CO.IN].[ERPHRDB].[dbo].[EMPMASTERINACTIVE] where psa in (" + Session["auth_psa"] + ") union all SELECT distinct [PSA], [LOCATION] FROM [ERPHR.NTPCLAKSHYA.CO.IN].[ERPHRDB].[dbo].[EMPMASTERINACTIVE] where psa in (" + Session["auth_psa"] + ") and PSA <> '' and LOCATION <> '' order by location ";
            //        //else
            //        //    SqlDataSource_PSA.SelectCommand = "SELECT top 1 '%' as PSA,'  All' as Location FROM [ERPHR.NTPCLAKSHYA.CO.IN].[ERPHRDB].[dbo].[EMPMASTERINACTIVE]  union all SELECT distinct [PSA], [LOCATION] FROM [ERPHR.NTPCLAKSHYA.CO.IN].[ERPHRDB].[dbo].[EMPMASTERINACTIVE] where  PSA <> '' and LOCATION <> '' order by location ";
            ...
            //                if (Session["role"].ToString() == "S")
            //                    cmd_getpsa = new SqlCommand("SELECT top 1 '%' as PSA,'  All' as Location FROM [ERPHR.NTPCLAKSHYA.CO.IN].[ERPHRDB].[dbo].[EMPMASTERINACTIVE] where pa in (" + Session["auth_pa"] + ") union all SELECT distinct [PSA], [LOCATION] FROM [ERPHR.NTPCLAKSHYA.CO.IN].[ERPHRDB].[dbo].[EMPMASTERINACTIVE] where pa in (" + Session["auth_pa"] + ") and PSA <> '' and LOCATION <> '' order by location ", con);
            //                else
            //                    cmd_getpsa = new SqlCommand("SELECT top 1 '%' as PSA,'  All' as Location FROM [ERPHR.NTPCLAKSHYA.CO.IN].[ERPHRDB].[dbo].[EMPMASTERINACTIVE]  union all SELECT distinct [PSA], [LOCATION] FROM [ERPHR.NTPCLAKSHYA.CO.IN].[ERPHRDB].[dbo].[EMPMASTERINACTIVE] where  PSA <> '' and LOCATION <> '' order by location ", con);
            ...
            //        // bind_grid();
            //        TxtMultiEmp.Text = "";
            //        // SqlDataSource_EMP.SelectCommand = "SELECT top 1 '%' as PERNR,'   All' as EMPNAME FROM [ERPHR.NTPCLAKSHYA.CO.IN].[ERPHRDB].[dbo].[EMPMASTERINACTIVE] union all SELECT [PERNR], RIGHT([PERNR],6)+' / '+[FIRSTNAME]+' '+[LASTNAME] as EMPNAME FROM [ERPHR.NTPCLAKSHYA.CO.IN].[ERPHRDB].[dbo].[EMPMASTERINACTIVE]  order by empname";
            //        //  else
            //        //       SqlDataSource_EMP.SelectCommand = "SELECT top 1 '%' as PERNR,'   All' as EMPNAME FROM [ERPHR.NTPCLAKSHYA.CO.IN].[ERPHRDB].[dbo].[EMPMASTERINACTIVE] where pa in (" + Session["auth_pa"] + ") union all SELECT [PERNR], RIGHT([PERNR],6)+' / '+[FIRSTNAME]+' '+[LASTNAME] as EMPNAME FROM [ERPHR.NTPCLAKSHYA.CO.IN].[ERPHRDB].[dbo].[EMPMASTERINACTIVE] where pa in (" + Session["auth_pa"] + ") order by empname";
            ...
            //                }
            //                SqlCommand cmd_getpsa = null;
            //                cmd_getpsa = new SqlCommand("SELECT top 1 '%' as PSA,'  All' as Location FROM [ERPHR.NTPCLAKSHYA.CO.IN].[ERPHRDB].[dbo].[EMPMASTERINACTIVE]  union all SELECT distinct [PSA], [LOCATION] FROM [ERPHR.NTPCLAKSHYA.CO.IN].[ERPHRDB].[dbo].[EMPMASTERINACTIVE] where  PSA <> '' and LOCATION <> '' and PA='" + rcb_pa.SelectedValue + "' order by location ", con);
            //                SqlDataAdapter ad_psa = new SqlDataAdapter();
            //                ad_psa.SelectCommand = cmd_getpsa;
            //                ad_psa.Fill(dt_psa);
            //                rcb_psa.DataSource = dt_psa;
            ...
            //            con.Close();
            //        }
            //        //SqlDataSource_EMP.SelectCommand = "SELECT top 1 '%' as PERNR,'   All' as EMPNAME FROM [ERPHR.NTPCLAKSHYA.CO.IN].[ERPHRDB].[dbo].[EMPMASTERINACTIVE] union all SELECT [PERNR], RIGHT([PERNR],6)+' / '+[FIRSTNAME]+' '+[LASTNAME] as EMPNAME FROM [ERPHR.NTPCLAKSHYA.CO.IN].[ERPHRDB].[dbo].[EMPMASTERINACTIVE]  WHERE PA = @PA order by empname";
            //        //SqlDataSource_EMP.DataBind();
